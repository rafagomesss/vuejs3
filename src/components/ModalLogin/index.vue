  ...
  <div class="mt-16">
    <form @submit.prevent="handleSubmit">
      <label class="block">
        ...
        <input v-model="state.email.value" :class="{
          'border-brand-danger': !!state.email.errorMessage
        }" class="block w-full px-4 py-3 mt-1 text-lg bg-gray-100 border-2 border-transparent rounded" type="email"
      ...
      <label class="block mt-9">
        ...
        <input v-model="state.password.value" :class="{
          'border-brand-danger': !!state.password.errorMessage
        }" class="block w-full px-4 py-3 mt-1 text-lg bg-gray-100 border-2 border-transparent rounded" type="password"
          placeholder="jane.dae@gmail.com">
      ...
      <button :disabled="state.isLoading" :class="{
